...
var Enemy = function(i) {
    ...
    this.sprite = 'images/mutant-enemy-bug.png';
...
// Set scores and lifes counters
var score = 0,
    lifes = 5,
    scoresCounter = document.getElementById("scores"),
    lifesCounter = document.getElementById("lifes");

var lifesList = document.getElementById("lifesList");
var life = lifesList.firstChild;
var listItem = "<li class='life'></li>";

// Update lifes and score data, it is called when player gets to the other side or when it collides with an enemy
var updateData = function(score, lifes) {
    if (lifes === 0) {
        alert("Game Over. Your score was " + score + " points.");
        document.location.reload();
    } else if (score === 1000)
        alert("Congrats!!! You are winning " + score + " points.");
    else {
        lifesCounter.innerHTML = 'Lifes ' + lifes;
